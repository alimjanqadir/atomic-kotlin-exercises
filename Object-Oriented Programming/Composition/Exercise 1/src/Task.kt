...
open class Shape(val name: String, open val color: String) {
...
class Rectangle(val height: Int, private val width: Int, color: String) : Shape("rectangle of size ${height}x$width", color) {}
